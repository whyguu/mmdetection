...
img_norm_cfg = dict(
    ...
    mean=[204.984, 209.792, 182.625], std=[29.662, 19.433, 27.735], to_rgb=True)
data = dict(
    imgs_per_gpu=2,
    workers_per_gpu=1,
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'jinnan2_round1_train_20190305/train_no_poly_coco.json',
        img_prefix=data_root + 'jinnan2_round1_train_20190305/restricted/',
        img_scale=[(1344, 800), (1216, 672), (1088, 544)],
...
resume_from = None
# resume_from = './myweights/cascade_dc3_5_r101_ep20_bs2_ohem1_cw/epoch_20.pth'
workflow = [('train', 1)]
